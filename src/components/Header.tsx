      ...
      <div className="bg-[#0F172A] text-slate-200 text-xs px-4 py-1.5 flex flex-wrap items-center justify-between gap-3 border-b border-slate-800">
        <div className="flex items-center gap-4 overflow-x-auto py-0.5 scrollbar-none">
          ...
          <div className="flex items-center gap-1 text-slate-300 font-mono text-[11px]">
            ...
            <span className="text-emerald-400 text-[10px] bg-emerald-950/80 px-1 rounded border border-emerald-800">
              ±0.4°C СТАБИЛЬНО
            </span>
          </div>
        ...
        {/* View mode toggle (Mobile Deck Preview vs Workbench) */}
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-3 sm:px-3.5 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-150 cursor-pointer whitespace-nowrap ${
                    isActive
